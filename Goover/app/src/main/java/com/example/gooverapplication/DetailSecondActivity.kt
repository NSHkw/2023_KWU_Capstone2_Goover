...
class DetailSecondActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val entryId = dbHelper.getEntryId2(category, title, memo, cycle, date, answer)
        ...
        if (entryId != null) {
            val imagePathsString = dbHelper.getImagePaths2(entryId)
