...
class HomeTodoInAdapter(context: Context, val itemList: MutableList<RecyclerInViewModel>) :
    RecyclerView.Adapter<HomeTodoInAdapter.Holder>() {
...
class HomeTodoDecoration(val context: Context): RecyclerView.ItemDecoration() {
